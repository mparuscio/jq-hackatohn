...
pg = st.navigation([
    ...
    st.Page("home.py", title="Problem Statement"),
    st.Page("architecture.py", title="Architecture"),
    st.Page("page1.py", title="Demo & Insights"),
    ...
    st.Page("page6.py", title="Example - Forecasts"),
    st.Page("conclusions.py", title="Conclusion"),
